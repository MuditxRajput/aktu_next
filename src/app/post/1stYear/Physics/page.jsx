...
const EngineeringPhysics = () => {
  ...
  const pageKeywords =
    "Engineering Physics AKTU Quantum, Aktu Quantum, B.Tech 1st Year, PDF, Syllabus, aktu, aktu result, aktu one view, Aktu 1st year quantum pdf free";
    const canonicalUrl = "http://aktu-quantum.online/post/1stYear/Physics";
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content="http://aktu-quantum.online/post/1stYear/Physics"
        />
            ...
            <div className=" rounded-md shadow-sm shadow-gray-700 p-7">
              ...
              <div className="mb-6">
                <div className="flex justify-center items-center mb-3">
                  <Image
                    src={engineeringPhysics}
                    alt="Syllabus of Engineering Physics AKTU Quantum pdf"
                ...
                <p>
                  ...
                  Don't worry! In this post, I will share the Engineering Physics 
                  AKTU Quantum pdf with you. From this AKTU quantum pdf, you will 
                  easily get the ideas of question patterns from the last 4-5 years. 
                  Most importantly, this pdf is the latest and covers all the syllabus 
                  as per AKTU syllabus. So without wasting any time, let's see how you 
                  can get the Latest Engineering Physics AKTU Quantum pdf for B-Tech in 1st year.
                </p>
              ...
              <div>
                ...
                <p>
                  You need to follow some steps to get access to the Engineering Physics Quantum.
                </p>
                ...
                <p>
                  ...
                  Engineering Physics comes under 1 year, you can click on the
                  1-year button. After clicking on the 1-year button, the pdf
                  section will be refreshed, and all quantum is of 1 years.
                  Scroll down and find the Engineering Physics pdf, click on it,
                ...
                <p>
                  ...
                  page, you see the search bar, click on it, and type Engineering Physics.
                  ...
                  below it you see the Engineering Physics AKTU quantum pdf. Click on
                  it and access it easily. These are all the steps you need to follow to get
                  access to Engineering Physics AKTU quantum pdf.
                </p>
                <h3 className="text-lg font-semibold mb-1 mt-2">
                  Syllabus of Engineering Physics AKTU Quantum pdf
                </h3>
                <p>
                  In Engineering Physics pdf, there are a total of 5 units as per the AKTU syllabus of Engineering Physics.
                  <br /> 
                  <span className="font-semibold">Unit 1: Relative Mechanics</span> 
                  <br />
                  <span className="font-semibold">Unit 2: Electromagnetic Field Theory</span>
                  <br />
                  <span className="font-semibold">Unit 3: Quantum Mechanics</span>
                  <br />
                  <span className="font-semibold">Unit 4: Wave Optics</span>
                  <br />
                  <span className="font-semibold">Unit 5: Fiber Optics and Laser</span>
                  <br />
                </p>
                <p className="text-lg font-semibold mb-1 mt-1">
                ...
                <p>
                  In this post, we learned how to access Engineering Physics AKTU
                  Quantum pdf for B-tech 1st year in just a few steps. I hope you
...
export default EngineeringPhysics;
