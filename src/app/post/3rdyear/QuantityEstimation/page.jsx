...
const QuantityEstimation = () => {
  ...
  const pageKeywords =
    "Quantity Estimation, Construction Management, AKTU Quantum, B.Tech 3rd Year, PDF, Syllabus, Question Patterns";
    const canonicalUrl = "http://aktu-quantum.online/post/3rdyear/QualtityEstimation";
  return (
    <>
      <Head>
            ...
            <div className="rounded-md shadow-sm shadow-gray-700 p-7">
              ...
              <div className="mb-6">
                <div className="flex justify-center items-center mb-3">
                  <Image
                    src={quantityEstimationImg}
                    alt="Syllabus of Quantity Estimation & Construction Management"
                ...
                <p>
                  ...
                  concerned about your exam, especially Quantity Estimation &
                  Construction Management. Don't worry! In this post, I will
                  share the Quantity Estimation & Construction Management AKTU
                  ...
                  time, let's see how you can get the Latest Quantity Estimation
                  & Construction Management AKTU Quantum PDF for B-Tech in 3rd
                  year.
                </p>
              ...
              <div>
                <h2 className="text-xl font-semibold mb-4 mt-1">
                  How to access the Latest Quantity Estimation & Construction
                  Management AKTU Quantum pdf
                </h2>
                <p>
                  You need to follow some steps to get access to the Quantity
                  Estimation & Construction Management Quantum.
                </p>
                ...
                <p>
                  ...
                  Quantity Estimation & Construction Management comes under 3rd
                  year, you can click on the 3rd-year button. After clicking on
                  the 3rd-year button, the pdf section will be refreshed, and
                  all quantum is of 3rd years. Scroll down and find the Quantity
                  Estimation & Construction Management pdf, click on it, and
                  access it directly.
                </p>
                <p className="text-lg font-semibold mb-1 mt-1">
                ...
                <p>
                  ...
                  page, you see the search bar, click on it, and type Quantity
                  Estimation & Construction Management. Simply type the first
                  word of any AKTU quantum you want to find. After writing,
                  click on the search button, and as you click on it, below it
                  you see the Quantity Estimation & Construction Management AKTU
                  quantum pdf. Click on it and access it easily.
                </p>
                <p>
                  These are all the steps you need to follow to get access to
                  Quantity Estimation & Construction Management AKTU quantum
                  pdf.
                </p>
                <h3 className="text-lg font-semibold mb-1 mt-2">
                  Syllabus of Quantity Estimation & Construction Management AKTU
                  Quantum pdf.
                </h3>
                <p>
                  In Quantity Estimation & Construction Management pdf, there
                  are a total of 5 units as per the AKTU syllabus of Quantity
                  Estimation & Construction Management.
                  <br />{" "}
                  <span className="font-semibold">
                    Unit 1: Quantity Management For Buildings
                  </span>{" "}
                  <br />
                  <span className="font-semibold">
                  ...
                  <br />
                  <span className="font-semibold">
                    Unit 3: Elements Of Management
                  </span>{" "}
                  <br />
                  <span className="font-semibold">
                    Unit 4: Equipment Management
                  </span>{" "}
                  <br />
                  <span className="font-semibold">
                ...
                <p>
                  In this post, we learned how to access Quantity Estimation &
                  Construction Management AKTU Quantum pdf for B-tech 3rd year
