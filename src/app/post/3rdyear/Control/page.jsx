...
import controlSystem from "../../../PostImage/control.png"; // Assuming you have an image for Control System
...
const ControlSystem = () => {
  ...
  const pageKeywords =
    "Control System AKTU Quantum, Aktu Quantum, B.Tech 3rd Year, PDF, Syllabus, aktu, aktu result, aktu one view, Aktu 3rd year quantum pdf free";
    const canonicalUrl = "http://aktu-quantum.online/post/3rdyear/Control";
  return (
    <>
      <Head>
            ...
            <div className="rounded-md shadow-sm shadow-gray-700 p-7">
              ...
              <div className="mb-6">
                <div className="flex justify-center items-center mb-3">
                  <Image
                    src={controlSystem}
                    alt="Syllabus of Control System AKTU Quantum pdf"
                ...
                <p>
                  ...
                  concerned about your exam, especially Control System. Don't
                  worry! In this post, I will share the Control System AKTU Quantum
                  ...
                  can get the Latest Control System AKTU Quantum pdf for B-Tech in
                  3rd year.
                </p>
              ...
              <div>
                <h2 className="text-xl font-semibold mb-4 mt-1">
                  How to access the Latest Control System AKTU Quantum pdf
                </h2>
                <p>
                  You need to follow some steps to get access to the Control System
                  Quantum.
                </p>
                ...
                <p>
                  ...
                  our official website, where you see the years button. As Control
                  System comes under 3rd year, you can click on the 3rd-year
                  ...
                  and find the Control System pdf, click on it, and access it
                  directly.
                </p>
                <p className="text-lg font-semibold mb-1 mt-1">
                ...
                <p>
                  ...
                  you see the search bar, click on it, and type Control System.
                  ...
                  below it you see the Control System AKTU quantum pdf. Click on it
                  and access it easily. These are all the steps you need to follow to
                  get access to Control System AKTU quantum pdf.
                </p>
                <h3 className="text-lg font-semibold mb-1 mt-2">
                  Syllabus of Control System AKTU Quantum pdf
                </h3>
                <p>
                  In Control System pdf, there are a total of 5 units as per the AKTU syllabus of Control System.
                  <br />
                  <span className="font-semibold">Unit 1: Control System Concepts</span>
                  <br />
                  <span className="font-semibold">Unit 2: The Response Analyse</span>
                  <br />
                  <span className="font-semibold">Unit 3: Stability & Algebraic Criteria</span>
                  <br />
                  <span className="font-semibold">Unit 4: Frequency Response Analysis</span>
                  <br />
                  <span className="font-semibold">Unit 5: Introduction To Design</span>
                  <br />
                </p>
                <p className="text-lg font-semibold mb-1 mt-1">
                ...
                <p>
                  In this post, we learned how to access Control System AKTU
