            ...
            <div className=" rounded-md shadow-sm shadow-gray-700 p-7">
              ...
              <div className="mb-6">
                <div className="flex justify-center items-center mb-3">
                  <Image
                    src={advanceWelding}
                    alt="Syllabus of Advance Welding AKTU Quantum pdf"
                ...
                <p>
                  ...
                  Don't worry! In this post, I will share the Advance Welding 
                  ...
                  can get the Latest Advance Welding AKTU Quantum pdf for B-Tech in 3rd year.
                </p>
              ...
              <div>
                ...
                <p>
                  You need to follow some steps to get access to the Advance Welding Quantum.
                </p>
                ...
                <p>
                  ...
                  page, you see the search bar, click on it, and type Advance Welding.
                  ...
                  below it you see the Advance Welding AKTU quantum pdf. Click on
                  it and access it easily. These are all the steps you need to follow to get
                  access to Advance Welding AKTU quantum pdf.
                </p>
                <h3 className="text-lg font-semibold mb-1 mt-2">
                  Syllabus of Advance Welding AKTU Quantum pdf
                </h3>
                <p>
                  In Advance Welding pdf, there are a total of 5 units as per the AKTU syllabus of Advance Welding.
                  <br /> 
                  <span className="font-semibold">Unit 1: Welding arc & power source</span> 
                  <br />
                  <span className="font-semibold">Unit 2: welding process</span>
                  <br />
                  <span className="font-semibold">Unit 3: heat flow in welding</span>
                  <br />
                  <span className="font-semibold">Unit 4: repair & maintenance welding</span>
                  <br />
                  <span className="font-semibold">Unit 5: weld design & welding codes</span>
                  <br />
                </p>
                <p className="text-lg font-semibold mb-1 mt-1">
                ...
                <p>
                  In this post, we learned how to access Advance Welding AKTU
