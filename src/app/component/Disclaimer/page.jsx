    ...
    <div className="container px-4 py-8">
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <h2 className="text-2xl font-bold mb-2">
          Disclaimers for aktu-quantum
        </h2>

        <p className=" mb-4">
          All the information on this website - aktu-quantum.store - is
          published in good faith and for general information purpose only.
          aktu-quantum does not make any warranties about the completeness,
          reliability and accuracy of this information. Any action you take upon
          the information you find on this website (aktu-quantum), is strictly
          at your own risk. aktu-quantum will not be liable for any losses
