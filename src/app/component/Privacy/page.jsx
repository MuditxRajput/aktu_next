  ...
  return (
    <div className="container px-10 py-8">
        <div className="bg-white rounded-lg shadow-md p-10 ">
          ...
          <br></br>
          <h3 className="text-black text-xl font-semibold">Interpretation</h3>
          <p>
          ...
          <ul className="list-disc">
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to aktu-quantum.
              </p>
            </li>
            <br></br>
            <li>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to aktu-quantum, accessible from{" "}
                <a
                  href="aktu-quantum.store"
          ...
          <br></br>
          <h4 className="font-semiold text-lg ">
          ...
          <h3 className="font-semibold text-lg">Use of Your Personal Data</h3>
          ...
          <br></br>
          <ul>
            <li>By email: muditrajputpersonal@gmail.com</li>
          </ul>
        </div>
      </div>
  )
